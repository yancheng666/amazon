				...
				<div
					...
					<input type="hidden" name="method" value="login" /> 
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" id="username" name="username" value="${ cookie.existName.value }"
									placeholder="请输入用户名" required>${msg}
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" class="form-control" id="inputPassword3" name="quickmark"
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-10">
								<div class="checkbox">
									<label> <input type="checkbox" name="autoLogin" value="ok"> 自动登录
									</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <label> <input
										type="checkbox" name="isSave" value="ok"> 记住用户名
									</label>
								</div>
							</div>
						</div>
